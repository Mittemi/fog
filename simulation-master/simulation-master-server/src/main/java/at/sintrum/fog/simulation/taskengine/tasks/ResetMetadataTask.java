...
public class ResetMetadataTask extends FogTaskBase {
    ...
    public ResetMetadataTask(int offset, TrackExecutionState trackExecutionState, ApplicationStateMetadataApi applicationStateMetadataApi, AppEvolutionApi appEvolutionApi, AppRecoveryApi appRecovery, FogResourceService fogResourceService, FogCellStateService fogCellStateService, AppRequestClient appRequestClient) {
    ...
    protected boolean internalExecute() {
        reset(applicationStateMetadataApi, appEvolutionApi, appRecovery, fogResourceService, fogCellStateService, appRequestClient);
        return true;
    }

    public static void reset(ApplicationStateMetadataApi applicationStateMetadataApi, AppEvolutionApi appEvolutionApi, AppRecoveryApi appRecovery, FogResourceService fogResourceService, FogCellStateService fogCellStateService, AppRequestClient appRequestClient) {
