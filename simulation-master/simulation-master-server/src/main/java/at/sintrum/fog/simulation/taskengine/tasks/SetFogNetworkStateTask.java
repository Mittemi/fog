...
public class SetFogNetworkStateTask extends FogTaskBase {
    ...
    public SetFogNetworkStateTask(int offset, TaskListBuilder.TaskListBuilderState.AppTaskBuilder.TrackExecutionState trackExecutionState, FogIdentification fogIdentification, boolean isOnline, boolean serviceOnly, FogCellStateService fogCellStateService) {
