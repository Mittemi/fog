...
public class SetResourceLimitTask extends FogTaskBase {
    ...
    public SetResourceLimitTask(int offset, TrackExecutionState trackExecutionState, ResourceInfo resourceInfo, FogIdentification fogIdentification, FogResourceService fogResourceService) {
